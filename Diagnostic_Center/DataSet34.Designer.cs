...
namespace Diagnostic_Center {
    ...
    public partial class DataSet34 : global::System.Data.DataSet {
        ...
        public partial class salaryDataTable : global::System.Data.TypedTableBase<salaryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public salaryRow AddsalaryRow(string employee_id, string name, double basic_salary, double additional, double total, double minimize, double net_total, string month, string year, string date) {
...
namespace Diagnostic_Center.DataSet34TableAdapters {
    ...
    public partial class salaryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[salary] ([employee_id], [name], [basic_salary], [additional], [total], [minimize], [net_total], [month], [year], [date]) VALUES (@employee_id, @name, @basic_salary, @additional, @total, @minimize, @net_total, @month, @year, @date);
SELECT id, employee_id, name, basic_salary, additional, total, minimize, net_total, month, year, date FROM salary WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[salary] SET [employee_id] = @employee_id, [name] = @name, [basic_salary] = @basic_salary, [additional] = @additional, [total] = @total, [minimize] = @minimize, [net_total] = @net_total, [month] = @month, [year] = @year, [date] = @date WHERE (([id] = @Original_id) AND ((@IsNull_employee_id = 1 AND [employee_id] IS NULL) OR ([employee_id] = @Original_employee_id)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_basic_salary = 1 AND [basic_salary] IS NULL) OR ([basic_salary] = @Original_basic_salary)) AND ((@IsNull_additional = 1 AND [additional] IS NULL) OR ([additional] = @Original_additional)) AND ((@IsNull_total = 1 AND [total] IS NULL) OR ([total] = @Original_total)) AND ((@IsNull_minimize = 1 AND [minimize] IS NULL) OR ([minimize] = @Original_minimize)) AND ((@IsNull_net_total = 1 AND [net_total] IS NULL) OR ([net_total] = @Original_net_total)) AND ((@IsNull_month = 1 AND [month] IS NULL) OR ([month] = @Original_month)) AND ((@IsNull_year = 1 AND [year] IS NULL) OR ([year] = @Original_year)) AND ((@IsNull_date = 1 AND [date] IS NULL) OR ([date] = @Original_date)));
SELECT id, employee_id, name, basic_salary, additional, total, minimize, net_total, month, year, date FROM salary WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, employee_id, name, basic_salary, additional, total, minimize, net_tota" +
                "l, month, year, date FROM dbo.salary where month=@x and year=@y";
        ...
        public virtual int Insert(string employee_id, string name, global::System.Nullable<double> basic_salary, global::System.Nullable<double> additional, global::System.Nullable<double> total, global::System.Nullable<double> minimize, global::System.Nullable<double> net_total, string month, string year, string date) {
            if ((employee_id == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_basic_salary.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((double)(Original_basic_salary.Value));
            }
            else {
            ...
            if ((Original_additional.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((double)(Original_additional.Value));
            }
            else {
            ...
            if ((Original_minimize.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((double)(Original_minimize.Value));
            }
            else {
            ...
            if ((Original_net_total.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((double)(Original_net_total.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_year, 
                    string Original_date) {
            return this.Update(employee_id, name, basic_salary, additional, total, minimize, net_total, month, year, date, Original_id, Original_employee_id, Original_name, Original_basic_salary, Original_additional, Original_total, Original_minimize, Original_net_total, Original_month, Original_year, Original_date, Original_id);
        }
    }
